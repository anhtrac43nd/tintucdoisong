...
<?php
	if (isset($_POST["btnThem"])){
		...
		$qr = "
			...
			null,'$TieuDe','$TieuDe_KhongDau','$TomTat','$urlHinh','$Ngay','$idUser','$NoiDung','$idLT','$idTL','$SoLanXem','$TinNoiBat','$AnHien'
							...
							<div class="form">							
								<table class="table">
							     ...
							     <tr>
							        ...
							        <td><input type="text" name="tomtat" class="form-control"></td>
							      </tr>
							      <tr>
							        <td><P>hình ảnh bài viết</p></td>
							         <td><input type="textfield" name="hinhanh" class="form-control" id="urlHinh" ><input onclick="BrowseServer('','urlHinh')" type="button" name="btnChonFile" id="btnChonFile" value="Chọn file" /></td>  
							         <!-- <td><input type="file" name="hinhanh"></td> -->
							      </tr>
							      <tr>
							        <td><P>nội dung bài viết</p></td>
							        <td><textarea name="noidung" class="form-control" id="Content" cols="30" rows="10"></textarea>
								        <script type="text/javascript">
							      ...
							      <tr>
							        ...
							        <td><select name="idtl" class="form-control" id="idTL">
										<option value="">Lựa chọn thể loại (danh mục cha)</option>
										<?php
							      ...
							      <tr>
							        <td><p>Tin nổi bật</p>
							        <td>&nbsp Nổi Bật &nbsp<input type="radio" name="rd_noibat" value="1">&nbsp Thường &nbsp<input type="radio" name="rd_noibat" value="0"></td>
							      </tr>>
							      <tr>
							        <td><p>Ẩn/Hiện</p>
							        <td>&nbsp Hiện &nbsp<input type="radio" name="rd_anhien" value="1">&nbsp Ẩn &nbsp<input type="radio" name="rd_anhien" value="0"></td>
							      </tr>					      
							  </table>							
							</div>
